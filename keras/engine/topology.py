...
class Container(Layer):
    ...
    def summary(self, line_length=100, positions=[.33, .55, .67, 1.], fh=None):
        ...
        print_summary(flattened_layers, getattr(self, 'container_nodes', None), line_length=line_length, positions=positions, fh=fh)
